...
final class MIMEType extends Enum
{
    ...
    const javavm = "application/java-vm";
    ...
    const ipng = "image/png";
    const cpng = "image/x-citrix-png";
    const xpng = "image/x-png";
    ...
    const pgpenc = "application/pgp-encrypted";
    const pgpsig = "application/pgp-signature";
